...
import image from "./misc/df126-52f2-11e5-b9a9-00259036a192_220x220_1.jpg";
                  ...
                  <div className="product product_horizontal">
                    ...
                    <div className="product_description">
                      <a href="#" className="product__link">
                        Ламинат 31 кл Kronospan Kronofix Афцелия Малайская 2,47
                        м.кв. 7 мм
                      </a>
                    </div>
                    ...
                    <div className="descriptionWrapper">
                      <p className="description">
                        Предназначена для облицовки стен внутри жилых (кухня,
                        ванная комната, туалет и пр.) и коммерческих (магазины,
                        кафе, отели и пр.) помещений.\n\nТон (оттенок) может
                        отличаться от партии к партии.\n\nСостав: огнеупорная
                        глина, пылевой шпат, кварцевый песок, каолин, красители,
                        фритта.\n\nСтепень блеска: глянцевый.\nКоличество на
                        поддоне: 96 коробок.\nПроизводитель: ОАО «Керамин»,
                        Беларусь.\n\nСопутствующие: клей для плитки, крестики,
                        затирка для швов, плиткорез.\n
                      </p>
                      <button className="bay" type="button">Купить</button> 
                    </div>
                      ...
                      <div className="product_count_wrapper">
                        <div className="stepper">
                          <input
                            ...
                            value="1"
                            />
                          <span className="stepper-arrow up">A</span>
